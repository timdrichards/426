import{p as U}from"./chunk-K2ZEYYM2-DZ1aCDmZ.js";import{p as H}from"./treemap-KMMF4GRG-YVX6V4UE-DAkHLkAY.js";import{g as V,s as Z,b as j,c as q,x as J,v as K,d as s,l as w,e as Q,H as X,aP as Y,aR as ee,aS as G,aT as te,h as ae,B as re,aU as ie,I as se}from"./two-cols.vue_vue_type_script_setup_true_lang-CJDLXhDB.js";import"./chunk-ZZTYOBSU-D_4eIk2i.js";import"./index-DjYCkgV5.js";import"./modules/vue-By0kx5rm.js";import"./modules/shiki-D4A4XSIB.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),P={getConfig:ne,clear:ce,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:q,getAccTitle:j,setAccDescription:Z,getAccDescription:V,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await H("pie",e);w.debug(a),fe(a,P)},"parse")},me=s(e=>`
  .pieCircle{
