import{p as U}from"./chunk-K2ZEYYM2-CNXo0red.js";import{p as H}from"./treemap-KMMF4GRG-YVX6V4UE-DapG6rxS.js";import{g as Q,s as V,a as Z,b as j,x as q,v as J,c as s,l as w,d as K,H as X,aO as Y,aQ as ee,aR as G,aS as te,f as ae,B as re,aT as ie,I as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-DtdXuID4.js";import"./chunk-ZZTYOBSU-6phniTmX.js";import"./index-lNEgrFqO.js";import"./modules/vue-BKQ5PWyQ.js";import"./modules/shiki-Dijba9tN.js";import"./lz-string-BCxBxReP.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),O={getConfig:ne,clear:ce,setDiagramTitle:J,getDiagramTitle:q,setAccTitle:j,getAccTitle:Z,setAccDescription:V,getAccDescription:Q,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await H("pie",e);w.debug(a),fe(a,O)},"parse")},me=s(e=>`
  .pieCircle{
